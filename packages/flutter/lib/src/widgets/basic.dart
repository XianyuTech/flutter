...
/// A widget that displays a [dart:ui.Image] directly.
///
/// This widget will notify Image widget whether the ui.Image is painted inside screen.
class AutoreleaseRawImage extends LeafRenderObjectWidget {
  /// Creates a widget that displays an image.
  ///
  /// The [scale], [alignment], [repeat], [matchTextDirection] and [filterQuality] arguments must
  /// not be null.
  AutoreleaseRawImage(SetNeedsImageCallback needsImageCallback,
  {
    Key key,
    this.image,
    this.imageWidth,
  ...
  /// Provide image dimension even if [image] is null.
  ...
  void _setNeedsImage(bool value) {
    ...
    _needsImageCallback(value);
  }

  @override
  AutoreleaseRenderImage createRenderObject(BuildContext context) {
    assert((!matchTextDirection && alignment is Alignment) || debugCheckHasDirectionality(context));
    return AutoreleaseRenderImage(
      _setNeedsImage,
      image: image,
  ...
  @override
  void updateRenderObject(BuildContext context, AutoreleaseRenderImage renderObject) {
    renderObject
      ..image = image
      ..imageWidth = imageWidth
      ..imageHeight = imageHeight
